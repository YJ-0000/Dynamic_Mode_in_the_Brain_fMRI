...
MDD_timeseries_extracted = cell(1,length(data_dir));
...
for ndir = 1:length(data_dir)
    ...
    MDD_timeseries_extracted{ndir} = temp_timeseries_extracted;
    sub_list{ndir} = temp_sub_list;
end
%% 
cd(current_path);

save results/MDD_timeseires_cortical_subcortical MDD_timeseries_extracted sub_list